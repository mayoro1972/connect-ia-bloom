...
const auditDomains: AuditDomainMatch[] = [
  ...
  { title: "Service Client", domainKey: "service-client", keywords: ["service client", "support client", "cx", "centre de contact", "customer support"] },
  { title: "Data & Analyse", domainKey: "data-analyse", keywords: ["data", "analyse", "analytique", "business intelligence", "dashboard", "bi"] },
  ...
  { title: "IT & Transformation Digitale", domainKey: "it-et-transformation-digitale", keywords: ["it", "informatique", "transformation digitale", "dsi", "integration", "digitale", "digital"] },
  ...
  { title: "Santé & Bien-être", domainKey: "sante-et-bien-etre", keywords: ["sante", "bien-etre", "hse", "qvt", "prevention", "wellness", "health"] },

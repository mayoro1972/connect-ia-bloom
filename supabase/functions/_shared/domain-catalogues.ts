...
export const domainCatalogueAssets: DomainCatalogueAsset[] = [
  {
    ...
    pdfUrl: buildUrl("/catalogues-domaines-pdf/assistanat-et-secretariat.pdf"),
  ...
  },
  {
    ...
    pdfUrl: buildUrl("/catalogues-domaines-pdf/ressources-humaines.pdf"),
  ...
  },
  {
    ...
    pdfUrl: buildUrl("/catalogues-domaines-pdf/marketing-et-communication.pdf"),
  ...
  },
  {
    ...
    pdfUrl: buildUrl("/catalogues-domaines-pdf/finance-et-comptabilite.pdf"),
  ...
  },
  {
    ...
    pdfUrl: buildUrl("/catalogues-domaines-pdf/juridique-et-conformite.pdf"),
  ...
  },
  {
    ...
    pdfUrl: buildUrl("/catalogues-domaines-pdf/service-client.pdf"),
  ...
  },
  {
    ...
    pdfUrl: buildUrl("/catalogues-domaines-pdf/data-analyse.pdf"),
  ...
  },
  {
    ...
    pdfUrl: buildUrl("/catalogues-domaines-pdf/administration-et-gestion.pdf"),
  ...
  },
  {
    ...
    pdfUrl: buildUrl("/catalogues-domaines-pdf/management-et-leadership.pdf"),
  ...
  },
  {
    ...
    pdfUrl: buildUrl("/catalogues-domaines-pdf/it-et-transformation-digitale.pdf"),
  ...
  },
  {
    ...
    pdfUrl: buildUrl("/catalogues-domaines-pdf/formation-et-pedagogie.pdf"),
  ...
  },
  {
    ...
    pdfUrl: buildUrl("/catalogues-domaines-pdf/sante-et-bien-etre.pdf"),
  ...
  },
  {
    ...
    pdfUrl: buildUrl("/catalogues-domaines-pdf/diplomatie-et-affaires-internationales.pdf"),

...
const footerLabel = "TransferAI | Hub IA de Nettelecom CI | Modèle standard prospection V3";
...
export async function slide01(presentation, ctx) {
  ...
  kicker(slide, ctx, "Modèle standard | prospection B2B", 84, 110);
  title(slide, ctx, "Transformer l'IA\nen gains visibles\npour votre organisation", 84, 148, 560, 154, 42);
  body(
    slide,
    ctx,
    "Une proposition construite à partir du ROI de référence TransferAI, mais traduite dans le contexte du prospect autour de quatre terrains d'impact : pilotage commercial, opérations, relation client et procédures internes.",
    84,
    324,
    580,
    82,
  ...
  body(
    slide,
    ctx,
    "Audit IA gratuit + échange expert de 30 minutes pour qualifier les priorités, les KPI et la bonne séquence de déploiement.",
    84,
    488,
    548,
    46,
  ...
  body(
    slide,
    ctx,
    "Faire de l'IA un levier de pilotage, de rigueur opérationnelle et de qualité de service pour le prospect.",
    834,
    470,
    286,
    52,
...
export async function slide01toc(presentation, ctx) {
  ...
  title(slide, ctx, "Le parcours de lecture recommandé pour un deck de prospection executive", 72, 86, 920, 84, 34);
  body(
    slide,
    ctx,
    "Le sommaire rassure la direction, structure la lecture en PDF et prépare les deux temps forts du deck : ce que nous avons compris, puis ce que nous recommandons.",
    72,
    176,
    960,
    48,
  ...
  agendaRow(slide, ctx, 3, "Priorités métier du prospect", "où la valeur devient visible", 418, theme.navy);
  agendaRow(slide, ctx, 4, "ROI de référence et KPI", "ce qu'il faut mesurer", 476, theme.gold);
  agendaRow(slide, ctx, 5, "Cas d'usage et feuille de route", "ce que l'on recommande", 534, theme.orange);
...
export async function slide01sectionA(presentation, ctx) {
  ...
  sectionDivider(slide, ctx, {
    ...
    copy: "Cette première partie du deck doit montrer que nous comprenons les priorités métier, les irritants visibles et les KPI qui feront foi pour la direction.",

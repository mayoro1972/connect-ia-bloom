...
const footerLabel = "TransferAI | Hub IA de Nettelecom CI | Modèle deck commercial entreprise V3";
...
export async function slide01(presentation, ctx) {
  ...
  kicker(slide, ctx, "Modèle commercial | entreprises", 84, 110);
  title(slide, ctx, "Transformer l'IA\nen gains visibles\npour l'entreprise", 84, 148, 560, 154, 42);
  body(
    slide,
    ctx,
...
export async function slide01toc(presentation, ctx) {
  ...
  title(slide, ctx, "Le parcours de lecture recommandé pour un deck commercial entreprise", 72, 86, 920, 84, 34);
  body(
    slide,
    ctx,

...
29. [Workflow n8n - prospection ciblee multi-prospects](./39_Workflow_n8n_Prospection_Modele_Elton.md)
30. [n8n import-like blueprint - prospection multi-prospects V1](./40_n8n_Import_Like_Prospection_Modele_Elton_V1.md)
31. [Matrice de priorites commerciales et cas d'usage phares](./41_Matrice_Priorites_Commerciales_Cas_Usage.md)
32. [Workflow JSON n8n - prospection multi-prospects V1](./42_n8n_Prospection_Modele_Elton_V1.json)
33. [Workflow JSON n8n - prospection multi-prospects V2 Supabase validation email](./43_n8n_Prospection_Modele_Elton_V2_Supabase_Approval_Email.json)
34. [Workflow JSON n8n - prospection multi-prospects V3 validation puis envoi automatique](./44_n8n_Prospection_Modele_Elton_V3_Approval_AutoSend.json)
35. [Workflow V1 n8n - tableau noeud par noeud multi-prospects](./45_Tableau_Node_Par_Node_Workflow_V1.md)
36. [Workflow V1 n8n - guide de reconstruction multi-prospects](./46_Guide_Reconstruction_n8n_V1.md)
37. [Workflow JSON n8n - prospection multi-prospects V4 batch orchestrator](./47_n8n_Prospection_Multi_Prospect_V4_Batch.json)
38. [Brancher les sources prospects - Google Sheets, Airtable, Supabase](./48_Brancher_Sources_Prospects_GoogleSheets_Airtable_Supabase.md)
39. [V4 batch - quotas d'envoi et regles d'arret](./49_Guide_V4_Batch_Quotas_Stop_Rules.md)
40. [Schema Supabase - prospection multi-prospects](./50_Schema_Supabase_Prospection_Multi_Prospects.md)
41. [Commandes Supabase - migration, seed et premier batch](./51_Commandes_Supabase_Migration_Seed_Et_Premier_Batch.md)
42. [Template CSV / Google Sheets - 100 prospects](./53_Template_CSV_Google_Sheets_Prospects.md)

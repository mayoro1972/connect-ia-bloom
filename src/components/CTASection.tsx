      ...
      <div className="container mx-auto px-4 lg:px-8">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <a
              href="#"
              className="bg-gold-gradient font-semibold px-8 py-3.5 rounded-lg text-navy-deep inline-flex items-center gap-2 hover:opacity-90 transition-opacity"
            >
              Demander un devis <ArrowRight size={18} />
            </a>
            <a
              href="#"
              className="font-semibold px-8 py-3.5 rounded-lg inline-flex items-center gap-2 border transition-colors"
              style={{

    ...
    <section id="cta" className="relative py-24 overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div
          ...
          style={{
            background: "linear-gradient(135deg, hsl(225 55% 10% / 0.88), hsl(30 80% 30% / 0.8))",
          }}
        />
      </div>
      ...
      <div className="relative z-10 container mx-auto px-4 lg:px-8">
        <ScrollReveal className="text-center max-w-3xl mx-auto">
          <h2 className="font-heading text-3xl md:text-5xl font-bold mb-6" style={{ color: "hsl(0 0% 98%)" }}>
            Prêt à transformer vos <span className="text-gradient-orange">équipes</span> ?
          </h2>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <a
              href="#"
              className="bg-orange-gradient font-semibold px-8 py-3.5 rounded-lg inline-flex items-center gap-2 hover:opacity-90 transition-all hover:scale-105"

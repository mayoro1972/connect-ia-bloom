...
const sectionCopy = {
  fr: {
    ...
    items: [
      ...
      {
        title: "Je dirige une entreprise ou une équipe",
        desc: "Identifier les gains rapides, les cas d'usage IA prioritaires et le bon dispositif pour mes équipes.",
        cta: "Explorer les services entreprises",
        href: "/entreprises",
  ...
  en: {
    ...
    items: [
      ...
      {
        title: "I lead a company or a team",
        desc: "Identify quick wins, priority AI use cases, and the right path for my teams.",

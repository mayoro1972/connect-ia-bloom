                ...
                {TIME_SLOTS.map((slot) => {
                  ...
                  return (
                    <button
                      ...
                      className={[
                        "flex items-center justify-center rounded-xl border px-1 py-2 text-center text-[11px] sm:text-xs font-semibold tabular-nums whitespace-nowrap leading-none transition",
                        isActive

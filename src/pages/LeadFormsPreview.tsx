...
const models = {
  fr: {
    page: {
      ...
      contacts: "Contacts directs", whatsapp: "Assistant IA WhatsApp", urgent: "Urgence immédiate :", submit: { "demande-catalogue": "Recevoir le catalogue", "demande-renseignement": "Envoyer la demande", "contact-devis": "Envoyer la demande", "demande-referencement": "Envoyer la demande de référencement" },
  ...
  en: {
    page: {
      ...
      contacts: "Direct contacts", whatsapp: "AI WhatsApp assistant", urgent: "Urgent — direct line:", submit: { "demande-catalogue": "Receive catalogue", "demande-renseignement": "Send request", "contact-devis": "Send request", "demande-referencement": "Send listing request" },

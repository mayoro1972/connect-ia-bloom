...
const models = {
  fr: {
    page: {
      badge: "Demandes & contact", title: "Demande d'information, devis ou référencement", subtitle: "Choisis le bon modèle selon le besoin.", recommended: "Parcours recommandé",
      recommendedText: "1. Le visiteur choisit le bon modèle. 2. Il renseigne son besoin. 3. La demande mène vers la bonne suite : réponse email, orientation ou rendez-vous.",
      selected: "Modèle sélectionné", viewAppointment: "Voir le modèle RDV", fullName: "Nom complet *", email: "Email professionnel *", phone: "Téléphone / WhatsApp *", company: "Entreprise / institution *", website: "Site web", role: "Fonction / rôle", country: "Pays / ville",
      ...
      contacts: "Contacts directs", whatsapp: "Assistant IA WhatsApp", appointment: "Prendre rendez-vous", submit: { "demande-catalogue": "Recevoir le catalogue et proposer un RDV", "demande-renseignement": "Continuer vers le RDV de cadrage", "contact-devis": "Envoyer la demande et préparer le RDV", "demande-referencement": "Envoyer la demande de référencement" },
  ...
  en: {
    page: {
      ...
      recommendedText: "1. The visitor selects the right model. 2. They describe their need. 3. The request leads to the right next step: email reply, guidance, or meeting.",
      selected: "Selected model", viewAppointment: "View booking model", fullName: "Full name *", email: "Professional email *", phone: "Phone / WhatsApp *", company: "Company / institution *", website: "Website", role: "Role / position", country: "Country / city",
      ...
      contacts: "Direct contacts", whatsapp: "AI WhatsApp assistant", appointment: "Book a meeting", submit: { "demande-catalogue": "Receive catalogue and propose a meeting", "demande-renseignement": "Continue to the scoping meeting", "contact-devis": "Send request and prepare the meeting", "demande-referencement": "Send listing request" },

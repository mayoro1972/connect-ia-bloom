...
const models = {
  fr: {
    page: {
      badge: "Demandes & devis", title: "Demande Devis, Contact & RDV", subtitle: "Choisis le bon modele selon le besoin.", recommended: "Parcours recommande",
      recommendedText: "1. Le visiteur choisit le bon modele. 2. Il renseigne son besoin. 3. La demande mene vers une prise de rendez-vous contextualisee.",
      selected: "Modele selectionne", viewAppointment: "Voir le modele RDV", fullName: "Nom complet *", email: "Email professionnel *", phone: "Telephone / WhatsApp *", company: "Entreprise / institution *", role: "Fonction / role", country: "Pays / ville",
      domain: "Domaine demande", participants: "Nombre de participants estime", format: "Format souhaite", timeline: "Echeance / periode souhaitee", consentTitle: "Consentement requis",
      consentDesc: "Merci d'accepter la politique de confidentialite avant d'envoyer votre demande.", consentText: "J'accepte que mes donnees soient traitees uniquement pour repondre a ma demande, dans le respect de la", privacy: "politique de confidentialite",
      load: "Charger l'exemple", sending: "Envoi en cours...", success: "Demande envoyee", successDesc: "Votre demande a bien ete enregistree. Vous pouvez maintenant choisir un rendez-vous de cadrage.", successPending: "Votre demande a bien ete enregistree. L'email de confirmation sera active une fois la messagerie finalisee.",
      error: "Envoi impossible", errorDesc: "Votre demande n'a pas pu etre enregistree. Merci de reessayer dans un instant.", exampleTitle: "Message suggere", receives: "Ce que recoit le prospect",
      receivesItems: ["Un accuse de reception clair et rassurant.", "Une reponse contextualisee selon le domaine et le besoin exprime.", "Une invitation a prendre rendez-vous pour cadrer la suite."],
      attached: "Lien attache a la demande", attachedText: "Une fois le formulaire valide, le prospect bascule vers un modele de prise de rendez-vous prerempli.", preview: "Previsualiser le modele RDV",
      contacts: "Contacts directs", whatsapp: "Assistant IA WhatsApp", appointment: "Prendre rendez-vous", submit: { "demande-catalogue": "Recevoir le catalogue et proposer un RDV", "demande-renseignement": "Continuer vers le RDV de cadrage", "contact-devis": "Envoyer la demande et preparer le RDV" },
      formats: ["Presentiel", "Hybride", "En ligne", "A definir"],
    },
    forms: {
      "demande-catalogue": { label: "Demande de catalogue", title: "Recevoir le catalogue d'un domaine", subtitle: "Brochure du domaine demande, sans prix affiches.", helper: "Ideal pour comparer les formations avant de parler budget.", outcome: ["Envoi du catalogue choisi", "Selection plus rapide", "Proposition de rendez-vous"], exampleLabel: "Exemple concret", exampleMessage: "Bonjour, nous souhaitons recevoir le catalogue du domaine Ressources Humaines afin d'identifier les formations les plus adaptees a notre equipe.", exampleData: { ...emptyForm, fullName: "Aminata Kone", email: "aminata.kone@entreprise.ci", phone: "+225 07 00 00 00 00", company: "Nova Talent Cote d'Ivoire", role: "Responsable Developpement RH", country: "Abidjan, Cote d'Ivoire", domain: "Ressources Humaines", participants: "8", format: "hybride", timeline: "Sous 30 jours", message: "Bonjour, nous souhaitons recevoir le catalogue du domaine Ressources Humaines afin d'identifier les formations les plus adaptees a notre equipe." } },
      "demande-renseignement": { label: "Demande de renseignement", title: "Etre oriente vers la bonne formation", subtitle: "Recueillir le contexte pour recommander le bon domaine.", helper: "Parfait si le besoin metier est clair mais pas encore la formation.", outcome: ["Orientation vers le bon domaine", "2 a 3 formations pertinentes", "Qualification avant echange"], exampleLabel: "Exemple concret", exampleMessage: "Nous voulons former notre equipe marketing a l'usage de l'IA pour la creation de contenu.", exampleData: { ...emptyForm, fullName: "Lina Mensah", email: "l.mensah@brandworks.africa", phone: "+233 24 000 0000", company: "BrandWorks Africa", role: "Marketing Manager", country: "Accra, Ghana", domain: "Marketing & Communication", participants: "6", format: "presentiel", timeline: "Dans le trimestre", message: "Nous voulons former notre equipe marketing a l'usage de l'IA pour la creation de contenu." } },
      "contact-devis": { label: "Contact / devis", title: "Recevoir une proposition sur mesure", subtitle: "Preparer une offre adaptee au format, au volume et au niveau souhaites.", helper: "A utiliser quand le besoin est deja assez structure.", outcome: ["Qualification commerciale", "Preparation d'une offre", "Invitation a un rendez-vous"], exampleLabel: "Exemple concret", exampleMessage: "Merci de nous adresser une proposition pour une session intra-entreprise sur le domaine Finance & Comptabilite.", exampleData: { ...emptyForm, fullName: "Jean-Marc Bamba", email: "jm.bamba@finaxis-group.com", phone: "+225 05 00 00 00 00", company: "Finaxis Group", role: "Directeur Administratif et Financier", country: "Abidjan, Cote d'Ivoire", domain: "Finance & Comptabilite", participants: "12", format: "presentiel", timeline: "Avant fin de mois", message: "Merci de nous adresser une proposition pour une session intra-entreprise sur le domaine Finance & Comptabilite." } },
    },
  },
  en: {
    page: {

...
const creatorHubCopy = {
  fr: {
    ...
    valueTitle: "Ce que les visiteurs doivent recevoir chaque semaine",
    valueItems: [
      "Des tips IA directement utilisables dans leur travail quotidien",
      "Des guides courts par métier: RH, finance, immobilier, marketing, administration, diplomatie",
      "Des nouveautés IA traduites en impact concret pour la Côte d'Ivoire et l'Afrique",
      "Des opportunités de missions, de jobs, de stages et de collaborations IA",
    ],
    audiencesTitle: "Les audiences à convertir en abonnés puis en apprenants",
    audiences: [
      { title: "Entrepreneurs", desc: "Automatiser, vendre mieux, gagner du temps" },
      { title: "Professionnels RH", desc: "Recruter, évaluer, former avec l'IA" },
      { title: "Marketeurs", desc: "Créer, publier, mesurer plus vite" },
      { title: "Immobilier", desc: "Générer des leads et produire des annonces" },
      { title: "Finance", desc: "Analyser, automatiser, sécuriser" },
      { title: "Juristes", desc: "Rechercher, synthétiser, rédiger" },
      { title: "Managers", desc: "Décider, piloter, transformer" },
      { title: "Étudiants & reconversion", desc: "Se former et entrer sur le marché IA" },
    ],
    ...
    newsletterTitle: "Le meilleur levier pour toucher 20 000 visiteurs qualifiés",
    newsletterDesc:
      "Si tu veux capter rapidement une audience utile, la newsletter doit devenir le cœur du système. Chaque édition doit former, montrer un gain concret, pousser vers les contenus longs et ouvrir vers les formations ou l'accompagnement.",
    newsletterBlocks: [
      { title: "Le tip métier de la semaine", desc: "1 astuce directement applicable dans le travail quotidien." },
      { title: "Le prompt prêt à copier", desc: "1 prompt commenté, contextualisé par secteur." },
  ...
  en: {
    ...
    valueTitle: "What visitors should receive every week",
    valueItems: [
      "AI tips they can use directly in their day-to-day work",
      "Short profession-specific guides for HR, finance, real estate, marketing, administration and diplomacy",
      "AI updates translated into concrete impact for Côte d'Ivoire and Africa",
      "Missions, jobs, internships and collaboration opportunities related to AI",
    ],
    audiencesTitle: "Audiences to convert into subscribers, then learners",
    audiences: [
      { title: "Entrepreneurs", desc: "Automate, sell better, save time" },
      { title: "HR professionals", desc: "Recruit, assess and train with AI" },
      { title: "Marketers", desc: "Create, publish and measure faster" },
      { title: "Real estate", desc: "Generate leads and produce listings" },
      { title: "Finance", desc: "Analyze, automate and secure" },
      { title: "Legal", desc: "Research, summarize and draft" },
      { title: "Managers", desc: "Decide, manage and transform" },
      { title: "Students & career switchers", desc: "Train and enter the AI market" },
    ],
    ...
    newsletterTitle: "The best lever to reach 20,000 qualified visitors",
    newsletterDesc:
      "If you want to build a useful audience fast, the newsletter needs to become the core of the system. Each edition should teach, show a concrete gain, push people to long-form content and open a path to training or support.",
    newsletterBlocks: [
      { title: "This week's business tip", desc: "1 tip that can be applied immediately at work." },
      { title: "Copy-ready prompt", desc: "1 prompt explained and contextualized by sector." },
